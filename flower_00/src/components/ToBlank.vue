    ...
    <div v-transfer-dom>
      <popup v-model="show6">
        <div class="popup1">
          ...
          <group>
            <x-address :title="title6" v-model="value6" :list="addressData" placeholder="请选择地址" inline-desc="可以设置placeholder" :popup-style="{zIndex: 502}" @on-shadow-change="onShadowChange"></x-address>
          </group>
        </div>
      </popup>
    </div>
